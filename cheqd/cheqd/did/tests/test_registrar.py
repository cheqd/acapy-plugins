...
@pytest.mark.asyncio
async def test_create(registrar_url, registrar, mock_did_create_options, mock_did_response):
    # Arrange
...
@pytest.mark.asyncio
async def test_update(registrar_url, registrar, mock_did_update_options, mock_did_response):
    # Arrange
